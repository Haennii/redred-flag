...
export const MOCK_DATA: Record<string, FinancialMetrics[]> = {
  kb: [
    ...
    {
      // cet1Ratio: 2022 사업보고서 전기열(DART _00760.xml 직접 추출)
      year: 2021,
      ...
      roe: 7.86, nim: 1.534, cet1Ratio: 14.50,
    },
    {
      // cet1Ratio: 2022 사업보고서 당기열(DART _00760.xml 직접 추출)
      year: 2022,
      ...
      roe: 8.67, nim: 1.711, cet1Ratio: 14.70,
    },
    {
      // cet1Ratio: 2024 사업보고서 전기열(크로스레퍼런싱 확정)
      year: 2023,
      ...
      roe: 8.29, nim: 1.817, cet1Ratio: 14.50,
    },
    {
      // cet1Ratio: 2024 사업보고서 당기열(DART _00760.xml 직접 추출)
      year: 2024,
      ...
      roe: 8.23, nim: 1.764, cet1Ratio: 14.91,
    },
  ],
  ...
  shinhan: [
    ...
    },
    {
      ...
      roe: 7.81, nim: 1.350, cet1Ratio: 14.07,
    },
    {
      // cet1Ratio: 2022 사업보고서 당기열(DART _00760.xml 직접 추출)
      year: 2022,
      ...
      roe: 9.03, nim: 1.591, cet1Ratio: 14.72,
    },
    {
      // cet1Ratio: 2024 사업보고서 전기열(크로스레퍼런싱 확정)
      year: 2023,
      ...
      roe: 8.41, nim: 1.571, cet1Ratio: 14.34,
    },
    {
      // cet1Ratio: 2024 사업보고서 당기열(DART _00760.xml 직접 추출)
      year: 2024,
      ...
      roe: 9.10, nim: 1.495, cet1Ratio: 14.62,
    },
  ],
  ...
  hana: [
    ...
    },
    {
      ...
      roe: 8.67, nim: 1.367, cet1Ratio: 14.64,
    },
    {
      // cet1Ratio: 2022 사업보고서 당기열(DART _00760.xml 직접 추출)
      year: 2022,
      ...
      roe: 10.46, nim: 1.512, cet1Ratio: 15.06,
    },
    {
      // cet1Ratio: 2024 사업보고서 전기열(크로스레퍼런싱 확정)
      year: 2023,
      ...
      roe: 10.82, nim: 1.537, cet1Ratio: 15.92,
    },
    {
      // cet1Ratio: 2024 사업보고서 당기열(DART _00760.xml 직접 추출)
      year: 2024,
      ...
      roe: 9.79, nim: 1.414, cet1Ratio: 16.06,
    },
  ],
  ...
  woori: [
    ...
    },
    {
      ...
      roe: 9.09, nim: 1.346, cet1Ratio: 12.68,
    },
    {
      // cet1Ratio: 2022 사업보고서 당기열(DART _00760.xml 직접 추출)
      year: 2022,
      ...
      roe: 10.43, nim: 1.558, cet1Ratio: 12.95,
    },
    {
      // cet1Ratio: 2024 사업보고서 전기열(크로스레퍼런싱 확정)
      year: 2023,
      ...
      roe: 9.07, nim: 1.532, cet1Ratio: 13.05,
    },
    {
      // cet1Ratio: 2024 사업보고서 당기열(DART _00760.xml 직접 추출)
      year: 2024,
